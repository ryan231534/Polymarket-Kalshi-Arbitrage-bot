    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            TripReason::MaxPositionPerMarket {
                ...
                write!(
                    f,
                    "Max position per market: {} has {} contracts (limit: {})",
            ...
            TripReason::MaxTotalPosition { position, limit } => {
                write!(
                    f,
                    "Max total position: {} contracts (limit: {})",
                    position, limit
                )
            }
...
impl std::fmt::Display for CircuitBreakerStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        write!(
            f,
            " | P&L: ${:.2} | Pos: {} contracts across {} markets | Errors: {}",
